<?php
  ...
  if(isset($_GET['seen']))
  {
    ...
    if($frm_data['seen']=='all'){
      $q = "UPDATE `user_querries` SET `seen`=?";
      $values = [1];
      ...
      $q = "UPDATE `user_querries` SET `seen`=? WHERE `sr_no`=?";
  ...
  if(isset($_GET['del']))
  {
    ...
    if($frm_data['del']=='all'){
      ...
      $q = "DELETE FROM `user_querries` WHERE `sr_no`=?";
      $values = [$frm_data['del']];
          ...
          <div class="card-body">
            ...
            <div class="table-responsive-md" style="height: 400px; overflow-y: scroll;">
              <table class="table table-hover border">
                ...
                <tbody>
                  <?php 
                    $q = "SELECT * FROM `user_querries` ORDER BY `sr_no` DESC";
