...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
  <h2 class="fw-bold text-center"style="font-family: 'Dancing Script', cursive;">OUR ROOMS</h2>
  ...
  <script>
    ...
    function fetch_rooms()
    {
      ...
      xhr.open("GET","userajax/rooms.php?fetch_rooms&chk_avail="+chk_avail+"&guests="+guests+"&facility_list="+facility_list,true);
